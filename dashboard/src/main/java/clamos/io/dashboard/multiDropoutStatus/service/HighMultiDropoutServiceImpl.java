...
public class HighMultiDropoutServiceImpl implements HighMultiDropoutService {
    ...
    public List<HighMultiDropoutDTO> getLocalHighDropoutList(String year) {
        ...
        QHighMultiDropoutEntity qEntity = QHighMultiDropoutEntity.highMultiDropoutEntity;

        List<HighMultiDropoutDTO> queryResult = queryFactory
                .select(Projections.bean(HighMultiDropoutDTO.class,
    ...
    @Override
    public List<HighMultiDropoutDTO> getEduHighDropoutList(String year) {
        int guri = 0;
        int donducheon = 0;
        int anyang = 0;
        int osan = 0;
