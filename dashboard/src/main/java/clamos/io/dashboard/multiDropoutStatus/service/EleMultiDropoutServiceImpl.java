...
public class EleMultiDropoutServiceImpl implements EleMultiDropoutService{
    ...
    public List<EleMultiDropoutDTO> getLocalElementDropoutList(String year) {
        ...
        QEleMultiDropoutEntity qEntity = QEleMultiDropoutEntity.eleMultiDropoutEntity;

        List<EleMultiDropoutDTO> queryResult = queryFactory
                .select(Projections.bean(EleMultiDropoutDTO.class,
    ...
    @Override
    public List<EleMultiDropoutDTO> getEduElementDropoutList(String year) {
